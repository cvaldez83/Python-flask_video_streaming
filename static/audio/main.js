...
//audioContextOptions.sampleRate = 8000; // CV
var audioInput = null,
    realAudioInput = null,
    inputPoint = null,
    recording = false;
...
function toggleRecording( e ) {
    if (e.classList.contains('recording')) {
        ...
        console.log("going to play on server");
        socketio.emit('play-recording'); // CV
        console.log("completed playing on server");
    } else {
        // start recording
        ...
        console.log(audioContext.sampleRate); // CV
    }
}
